...
urlpatterns = [
    ...
    path('shortlisted/', views.shortlisted_list, name='shortlisted_list'),
    path('scheduled-interview/', views.scheduled_interview, name='scheduled_interview'),
    ...
    path('add-test-question/', views.add_test_question, name='add_test_question'),
    path('allot-test/', views.allot_test, name='allot_test'),
    path('take-test/', views.take_test, name='take_test'),
    path('take-test/<int:assignment_id>/', views.take_test_detail, name='take_test_detail'),
    path('submit-test/<int:assignment_id>/', views.submit_test, name='submit_test'),
    path('take-test-result/<int:assignment_id>/', views.take_test_result, name='take_test_result'),
